...
var UserWhere = struct {
	...
	ID:    whereHelperint64{field: "\"busers\".\"id\""},
	Login: whereHelperstring{field: "\"busers\".\"login\""},
}

// UserRels is where relationship names are stored.
var UserRels = struct {
	AuthoredVideos string
}{
	AuthoredVideos: "AuthoredVideos",
}

// userR is where relationships are stored.
type userR struct {
	AuthoredVideos ArticleSlice `boil:"AuthoredVideos" json:"AuthoredVideos" toml:"AuthoredVideos" yaml:"AuthoredVideos"`
}
...
func (r *userR) GetAuthoredVideos() ArticleSlice {
	if r == nil {
		return nil
	}
	return r.AuthoredVideos
}
...
var (
	userAllColumns            = []string{"id", "login"}
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for busers")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count busers rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if busers exists")
	}

	return count > 0, nil
}

// AuthoredVideos retrieves all the barticle's Articles with an executor via author_id column.
func (o *User) AuthoredVideos(mods ...qm.QueryMod) articleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"barticles\".\"author_id\"=?", o.ID),
	)

	return Articles(queryMods...)
}

// LoadAuthoredVideos allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadAuthoredVideos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`barticles`),
		qm.WhereIn(`barticles.author_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice barticles")
	}
	...
	if singular {
		object.R.AuthoredVideos = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.AuthorID) {
				local.R.AuthoredVideos = append(local.R.AuthoredVideos, foreign)
				if foreign.R == nil {
					foreign.R = &articleR{}
				}
...
// AddAuthoredVideosG adds the given related objects to the existing relationships
// of the buser, optionally inserting them as new records.
// Appends related to o.R.AuthoredVideos.
// Sets related.R.author appropriately.
// Uses the global database handle.
func (o *User) AddAuthoredVideosG(ctx context.Context, insert bool, related ...*Article) error {
	return o.AddAuthoredVideos(ctx, boil.GetContextDB(), insert, related...)
}

// AddAuthoredVideosP adds the given related objects to the existing relationships
// of the buser, optionally inserting them as new records.
// Appends related to o.R.AuthoredVideos.
// Sets related.R.author appropriately.
// Panics on error.
func (o *User) AddAuthoredVideosP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Article) {
	if err := o.AddAuthoredVideos(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddAuthoredVideosGP adds the given related objects to the existing relationships
// of the buser, optionally inserting them as new records.
// Appends related to o.R.AuthoredVideos.
// Sets related.R.author appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddAuthoredVideosGP(ctx context.Context, insert bool, related ...*Article) {
	if err := o.AddAuthoredVideos(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddAuthoredVideos adds the given related objects to the existing relationships
// of the buser, optionally inserting them as new records.
// Appends related to o.R.AuthoredVideos.
// Sets related.R.author appropriately.
func (o *User) AddAuthoredVideos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Article) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			AuthoredVideos: related,
		}
	} else {
		o.R.AuthoredVideos = append(o.R.AuthoredVideos, related...)
	}
...
// SetAuthoredVideosG removes all previously related items of the
// buser replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.author's AuthoredVideos accordingly.
// Replaces o.R.AuthoredVideos with related.
// Sets related.R.author's AuthoredVideos accordingly.
// Uses the global database handle.
func (o *User) SetAuthoredVideosG(ctx context.Context, insert bool, related ...*Article) error {
	return o.SetAuthoredVideos(ctx, boil.GetContextDB(), insert, related...)
}

// SetAuthoredVideosP removes all previously related items of the
// buser replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.author's AuthoredVideos accordingly.
// Replaces o.R.AuthoredVideos with related.
// Sets related.R.author's AuthoredVideos accordingly.
// Panics on error.
func (o *User) SetAuthoredVideosP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Article) {
	if err := o.SetAuthoredVideos(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetAuthoredVideosGP removes all previously related items of the
// buser replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.author's AuthoredVideos accordingly.
// Replaces o.R.AuthoredVideos with related.
// Sets related.R.author's AuthoredVideos accordingly.
// Uses the global database handle and panics on error.
func (o *User) SetAuthoredVideosGP(ctx context.Context, insert bool, related ...*Article) {
	if err := o.SetAuthoredVideos(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetAuthoredVideos removes all previously related items of the
// buser replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.author's AuthoredVideos accordingly.
// Replaces o.R.AuthoredVideos with related.
// Sets related.R.author's AuthoredVideos accordingly.
func (o *User) SetAuthoredVideos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Article) error {
	query := "update \"barticles\" set \"author_id\" = null where \"author_id\" = $1"
	...
	if o.R != nil {
		for _, rel := range o.R.AuthoredVideos {
		...
		o.R.AuthoredVideos = nil
	}

	return o.AddAuthoredVideos(ctx, exec, insert, related...)
}

// RemoveAuthoredVideosG relationships from objects passed in.
// Removes related items from R.AuthoredVideos (uses pointer comparison, removal does not keep order)
// Sets related.R.author.
// Uses the global database handle.
func (o *User) RemoveAuthoredVideosG(ctx context.Context, related ...*Article) error {
	return o.RemoveAuthoredVideos(ctx, boil.GetContextDB(), related...)
}

// RemoveAuthoredVideosP relationships from objects passed in.
// Removes related items from R.AuthoredVideos (uses pointer comparison, removal does not keep order)
// Sets related.R.author.
// Panics on error.
func (o *User) RemoveAuthoredVideosP(ctx context.Context, exec boil.ContextExecutor, related ...*Article) {
	if err := o.RemoveAuthoredVideos(ctx, exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveAuthoredVideosGP relationships from objects passed in.
// Removes related items from R.AuthoredVideos (uses pointer comparison, removal does not keep order)
// Sets related.R.author.
// Uses the global database handle and panics on error.
func (o *User) RemoveAuthoredVideosGP(ctx context.Context, related ...*Article) {
	if err := o.RemoveAuthoredVideos(ctx, boil.GetContextDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveAuthoredVideos relationships from objects passed in.
// Removes related items from R.AuthoredVideos (uses pointer comparison, removal does not keep order)
// Sets related.R.author.
func (o *User) RemoveAuthoredVideos(ctx context.Context, exec boil.ContextExecutor, related ...*Article) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.AuthoredVideos {
			if rel != ri {
				continue
			}

			ln := len(o.R.AuthoredVideos)
			if ln > 1 && i < ln-1 {
				o.R.AuthoredVideos[i] = o.R.AuthoredVideos[ln-1]
			}
			o.R.AuthoredVideos = o.R.AuthoredVideos[:ln-1]
			break
		}
	}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"busers\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"busers\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"busers\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from busers")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no busers provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"busers\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"busers\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into busers")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update busers, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"busers\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update busers row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for busers")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for busers")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for busers")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"busers\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no busers provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert busers, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"busers\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert busers")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"busers\" WHERE \"id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from busers")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for busers")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from busers")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for busers")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"busers\".* FROM \"busers\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"busers\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if busers exists")
	}
