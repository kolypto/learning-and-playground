...
* Clock: **SCL**, **CLK**, **SCLK**
* Chip select: **CS** (Chip Select), **SS** (Slace Select), **CE** (Chip Enable)

* MOSI:

  * **SIMO** (Slave In / Master OUt), **MTSR** (Mater Tx / Slave Rx), **SPID** (SPI Data)
  * **SDI** (Serial Data In), **DI** (Data In), **DIN** (Data In), **SI** (Serial In), **SDA** (i2c term reused) - on slave devices
  * **SDO** (Serial Data Out), **DO** (Data Out), **DOUT** (Data Out), **SO** (Serial Out) - on master devices
  * **COPI** (Controller Out / Peripheral In), **PICO** (Periperal In / Controller Out), **COTI** (Controller Out / Target In)

* MISO:

  * **SOMI**, **MRST**, **SPIQ** (SPI Quad)
...
# tutorials/b18-eink/src/bin


# tutorials/b18-eink/src/bin/main.rs
